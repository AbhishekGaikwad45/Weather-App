        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-blue-400 p-4">
            <div className="w-full max-w-md bg-red rounded-xl shadow-md p-6">
                <form onSubmit={submitHandler} className="flex flex-col items-center  gap-4">
                    <input
                        className="w-full md:w-96 p-2 border border-blue-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
                ...
                {error ? (
                    <div className="text-red-500 mt-4 text-center">Error fetching weather data. Please try again.</div>
                ) : (
                    weatherInfo.length > 0 && (
                        <div className="mt-6 text-center space-y-2">
                            <h1 className="text-2xl font-bold">City: {weatherInfo[0].name}</h1>
                            <p className="text-lg text-green-700">Temperature: {weatherInfo[0].main.temp}°C</p>
